            ...
            if ($type === 'client') {
                ...
                if (empty($date_naissance_str)) {
                    ...
                    try {
                        ...
                        $user = new Client($nom, $prenom, $email, $password, $telephone, $date_naissance);
                ...
                if (empty($date_embauche_str) || empty($poste) || empty($salaire_str) || empty($role)) {
                    ...
                    try {
                        ...
                        $user = new Employe($nom, $prenom, $email, $password, $date_embauche, $poste, $salaire, $role, $telephone);

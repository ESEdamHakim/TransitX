      ...
      <header class="dashboard-header">
        ...
        <div class="header-right">
          ...
          <div class="actions-container">
            ...
            <button class="btn export-btn" id="export-pdf-btn">
              <i class="fas fa-file-pdf"></i> PDF
            </button>
            <button class="btn meeting-btn" id="start-meeting-btn">
              <i class="fas fa-video"></i> Réunion
            </button>
            <button class="btn ai-assistance-btn" id="ai-assistance-btn">
  ...
  <div class="modal" id="ai-modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <textarea id="ai-prompt" rows="4" placeholder="Exemple : Rédige un email professionnel pour informer un utilisateur que son compte a été mis à jour..."></textarea>

    ...
    <section class="bus-form-section">
      <div class="container">
        <div class="section-header">
          <h2>Modifier le Bus
          <p>Modifiez les informations du bus sélectionné.</p></h2>
        </div>
            ...
            <div class="form-grid">
              ...
              <div class="form-column">
                <div class="form-group">
                  ...
                  <input type="text" name="id_trajet" id="id_trajet" value="<?= $bus['id_trajet'] ?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select name="statut" id="statut">
                    ...
                    <option value="maintenance" <?= $bus['statut'] == 'maintenance' ? 'selected' : '' ?>>maintenance</option>
              ...
              <div class="form-column">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="date_mise_en_service" id="date_mise_en_service" value="<?= $bus['date_mise_en_service'] ?>">
                </div>
              </div>
            </div>

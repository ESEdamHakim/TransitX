            ...
            <div class="buses-grid">
              <div class="bus-card">
                <div class="bus-header">
                  <h3>B001 - Mercedes Citaro</h3>
                  <span class="status active">Actif</span>
                </div>
                <div class="bus-image">
                  <img src="../assets/images/bus-placeholder.jpg" alt="Bus">
                </div>
                <div class="bus-details">
                  <div class="detail">
                    <span class="label">Immatriculation:</span>
                    <span>125 TU 1234</span>
                  </div>
                  <div class="detail">

...
<div class="comment-likes" style="margin-top: 8px; display: flex; align-items: center; gap: 12px;">
    ...
    <span><?php echo $commentaire['nb_likes']; ?> J'aime</span>
    ...
    <span><?php echo $commentaire['nb_dislikes']; ?> Je n'aime pas</span>
</div>
...
document.querySelectorAll('.like-btn').forEach(function(btn) {
    btn.addEventListener('click', function(e) {
        ...
        fetch('like_commentaire.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
            body: `id_commentaire=${id}&action=${action}`
        })

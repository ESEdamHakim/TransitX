...
.logo {
    ...
    gap: 8px;
    letter-spacing: 1px;
    margin-left: 550px; /* Décale le logo de 20px vers la droite */
...
#languageDropdown {
  display: none;
  position: absolute;
  top: 100%; /* aligne le dropdown sous le bouton */
  right: 0;
  background-color: white;
...
.btn-speak {
    ...
    border-radius: 6px; /* Réduit les coins arrondis */
    font-size: 14px; /* Réduit la taille de la police */
    cursor: pointer;
    display: flex;
    align-items: center;
    gap: 6px; /* Réduit l'espacement entre l'icône et le texte */
...
.btn-speak:disabled {
    background-color: #e0e0e0; /* Fond gris clair pour état désactivé */
...
<header class="main-header">
    <div class="logo">
        <i class="fa fa-car"></i> Transit<span class="highlight">X</span>
    </div>
    ...
    <div class="language-selector">
        ...
        <div id="languageDropdown" style="display: none; position: absolute; background-color: white; padding: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1);">

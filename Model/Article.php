...
class Article {
    ...
    public function __construct($titre, $contenu, $date_publication, $photo, $auteur, $categorie,$tags, $id_article = null) {
    ...
    public function getCategorie() {
        return $this->categorie; // Retourne l'auteur de l'article
    }
    public function getTags() {
        return $this->tags;  // Retourne les tags de l'article
    }
    ...
    public function setTags($tags) {
        $this->tags = $tags;  // Modifie les tags de l'article
    }
}
?>
